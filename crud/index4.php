  ...
  <body>
      ...
      <form action="controles/recebeDadosJogos.php?modo=<?=$modo?>&id=<?=$id?>" name="frmCadastro" method="post">
       ...
       <div class="cadastroUsuario">
        ...
        <input type="checkbox"name="txtDestaque"   id="promocao" value="<?=$destaques?>">
            ...
            <td class="colunasResultado"><?=$rsJogos['descricao']?></td>
             <td class="colunasResultado"></td>               
               ...
               <td class="clnRegistro">
                ...
                <a  href="controles/editaDadosJogos.php?id=<?=$rsJogos['idjogos']?>">
                            <img src="img/edit.png" alt="Editar" title="Editar" class="editar">
                        </a>
                        <a onclick="return confirm('Tem certeza que deseja ecluir?');" href="controles/excluiDadosJogos.php?id=<?=$rsJogos['idjogos']?>">
